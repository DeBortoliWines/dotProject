...
GLOBAL $min_view, $m, $a, $user_id, $tab, $tasks, $project_id;
...
?>
	document.ganttFrm.display_option.value = "custom";
	f.submit()
}
...
function showThisMonth() {
	document.ganttFrm.display_option.value = "this_month";
	document.ganttFrm.submit();
}

function showFullProject() {
	document.ganttFrm.display_option.value = "all";
	document.ganttFrm.submit();
}

</script>

<form name="ganttFrm" method="post" action="?<?php 
...
echo $AppUI->_('submit');?>" onclick='javascript:document.ganttFrm.display_option.value="custom";submit();'>
	</td>
