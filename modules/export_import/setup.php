...
$config = array();
$config['mod_name'] = 'Export/Import';               // name the module
$config['mod_version'] = '1.0';               // add a version number
$config['mod_directory'] = 'export_import';          // tell dotProject where to find this module
...
$config['mod_ui_name'] = 'Export/Import';            // the name that is shown in the main menu of the User Interface
$config['mod_ui_icon'] = 'communicate.gif';     // name of a related icon
$config['mod_description'] = 'Export/Import data from projects';     // some description of the module
